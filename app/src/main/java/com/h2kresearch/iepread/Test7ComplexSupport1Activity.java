...
//          startActivity(intent);
    ...
    testStop.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        AlertDialog.Builder alert_confirm = new AlertDialog.Builder(Test7ComplexSupport1Activity.this);
