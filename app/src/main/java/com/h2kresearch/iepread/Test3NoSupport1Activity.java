...
public class Test3NoSupport1Activity extends AppCompatActivity {
  ...
  private void playInstructionAudio() {
    ...
    resourceNumber = getResources().getIdentifier("i_t3_1", "raw", getPackageName());
    ...
    mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
      ...
      public void onCompletion(MediaPlayer mp) {
        resourceNumber = getResources().getIdentifier("t3_1", "raw", getPackageName());
        mediaPlayer = MediaPlayer.create(getApplicationContext(), resourceNumber);
        mediaPlayer.setLooping(false);
        mediaPlayer.start();
      }
        ...
        if (indexString >= test1String.length) {
          ...
          try {
            ...
            for(int i=0; i<t3Answers.length; i++) {
              ...
              q.put("student_answer", t3Answers[i]);
              answer.put(q);
            }

            part.put("objective", answer);
            result.put("part3", part);
...
//          startActivity(intent);
    ...
    testStop.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        AlertDialog.Builder alert_confirm = new AlertDialog.Builder(Test3NoSupport1Activity.this);
